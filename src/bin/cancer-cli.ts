...
async function main(): Promise<void> {
  ...
  // "find clinical trials X", "analyze gene X", "pathway analysis X", "find drug targets X")
  // run directly against the public data-source tools — no LLM/API key. Falls through to the
  // agent if the prompt isn't one of these patterns.
  {
