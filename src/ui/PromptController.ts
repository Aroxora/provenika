...
export class PromptController {
   ...
   * @param text - The prompt text to pin, or null to clear
   */
  setPinnedPrompt(text: string | null): void {
    this.renderer.setPinnedPrompt(text);
  }
  ...
  getPinnedPrompt(): string | null {
    return this.renderer.getPinnedPrompt();
  }
  ...
  clearPinnedPrompt(): void {
    this.renderer.clearPinnedPrompt();
  }
