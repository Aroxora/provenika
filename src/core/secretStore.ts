...
const SECRET_DEFINITIONS: SecretDefinition[] = [
  ...
  // Cancer Research API Keys
  {
    id: 'NCBI_API_KEY',
    label: 'NCBI API Key',
    description: 'API key for NCBI E-utilities (PubMed, etc.). Free at https://www.ncbi.nlm.nih.gov/account/',
    envVar: 'NCBI_API_KEY',
    providers: [],
  },
  {
    ...
    description: 'API key for DrugBank database. Requires subscription at https://go.drugbank.com/',
    envVar: 'DRUGBANK_API_KEY',
    providers: [],
  },
  {
    id: 'COSMIC_API_KEY',
    label: 'COSMIC API Key',
    description: 'API key for COSMIC cancer mutation database. Register at https://cancer.sanger.ac.uk/cosmic',
    envVar: 'COSMIC_API_KEY',
    providers: [],
  },
];
