      ...
      @for (e of entries; track e.target) {
        <div class="entry">
          ...
          @if (socTop(e.target).length) {
            <div class="soc" title="Approved/clinical drugs that already hit this target (real ChEMBL mechanism data)">
              <span class="soc-lbl">Must beat</span>
              ...
              @if (socMore(e.target) > 0) { <span class="more">+{{ socMore(e.target) }} more</span> }
            </div>
          }
          <div class="links">
