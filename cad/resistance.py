...
RESISTANCE = {
    ...
    "KRAS": {
        "context": "KRAS G12C-mutant NSCLC / colorectal, on covalent G12C inhibitors",
        "mutations": [
            {"mut": "Y96D / Y96C", "confers": "resistance to covalent G12C inhibitors (sotorasib, "
             "adagrasib) — a switch-II-pocket mutation that blocks inhibitor binding",
             "covered_by": "no approved agent — next-gen tri-complex G12C inhibitors (e.g. RMC-6291) and "
             "RAS(ON) inhibitors are still investigational",
             "ref": "Tanaka et al., Cancer Discov 2021 (adagrasib Y96D); Awad et al., NEJM 2021",
             "url": "https://www.nejm.org/doi/full/10.1056/NEJMoa2105281"},
        ],
        "unmet": "on-target G12C resistance (Y96 switch-II pocket, secondary RAS mutations) and convergent "
        "RAS-MAPK reactivation are largely uncovered by approved agents — a live frontier for next-gen and "
        "RAS(ON) inhibitors.",
    },
}
