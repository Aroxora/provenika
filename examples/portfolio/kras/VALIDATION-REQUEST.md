...
|---|---|---|---|
| Sotorasib | approved | inhibitor | [ChEMBL](https://www.ebi.ac.uk/chembl/compound_report_card/CHEMBL4535757/) |
| Adagrasib | approved | inhibitor | [ChEMBL](https://www.ebi.ac.uk/chembl/compound_report_card/CHEMBL4594350/) |

**Already approved against this target:** Sotorasib, Adagrasib. The honest goal for a new molecule is a differentiated advantage over these, not merely activity.
...
```
Subject: Collaboration — experimental validation of GTPase KRas candidate(s)

Hello,

I'm sharing a small, fully-cited computational prioritization for GTPase KRas: public ChEMBL bioactivity re-ranked by structure-aware docking, with CHEMBL5573020 among the top candidates. These are hypotheses, not validated hits — I'm looking for a collaborator (or quote) to run the first experimental step: a biochemical IC50/Ki to confirm binding, then a selectivity panel.
