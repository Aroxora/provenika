...
```
主题：合作咨询 — Receptor tyrosine-protein kinase erbB-2 候选化合物的实验验证

您好，

我们基于公开的 ChEMBL 生物活性数据，并结合基于蛋白结构的 AutoDock Vina 分子对接进行重新打分排序，得到了一小批针对 Receptor tyrosine-protein kinase erbB-2 的候选化合物（其中 CHEMBL5221067 位列前茅）。
