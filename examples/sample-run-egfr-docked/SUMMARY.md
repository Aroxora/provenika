...
- 2/25 hits carry a PAINS (assay-interference) alert; 8/25 carry a Brenk (reactive/unstable-group) alert → `liabilities.json`.
- 16/25 fall in the Pfizer 3/75 zone (cLogP>3 & TPSA<75 — elevated in-vivo tox risk; Hughes 2008).
- Scrutinize before pursuing: CHEMBL6170958, CHEMBL420624, CHEMBL334697, CHEMBL491083, CHEMBL363815, CHEMBL3613702 …
...
- Re-prove it: `python3 cad/verify.py --run /root/runs/egfr`  (re-pulls each number from its live source).
